...
## FOSS4G embodies value of geospatial data science
:::: {.columns}
::: {.column width="40%"}
...
## AIS geospatial data
- Ship movement tracks collected from transponders. 
- Processed data is more convenient as we're more interested in visited ports than exact route taken. Used data from [Starboard](https://starboard.nz/) -  maritime intelligence from Xerra. 

## Understanding voyages and routes
![](assets/msc-alabama-voyages.png)

## Understanding voyages and routes
![](assets/northern-guild-voyages.png)

## Understanding ship schedules
